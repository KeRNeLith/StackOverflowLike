describe("stackoverflowlikeagclient.index", function() {

    var $rootScope, $state, $location;

    beforeEach(angular.mock.module('stackoverflowlikeagclient.index', function() {
    ...
    beforeEach(angular.mock.inject(function (_$rootScope_, $templateCache, _$state_, _$location_) {
        ...
        $templateCache.put('/stackoverflowlikeagclient/index/index.html', '');
    }));
