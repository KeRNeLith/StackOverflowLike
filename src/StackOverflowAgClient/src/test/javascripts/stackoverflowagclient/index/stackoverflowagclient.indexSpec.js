describe("stackoverflowagclient.index", function() {

    var $rootScope, $state, $location;

    beforeEach(angular.mock.module('stackoverflowagclient.index', function() {
    ...
    beforeEach(angular.mock.inject(function (_$rootScope_, $templateCache, _$state_, _$location_) {
        ...
        $templateCache.put('/stackoverflowagclient/index/index.html', '');
    }));
