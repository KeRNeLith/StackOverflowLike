...
<body ng-app="stackoverflowlikeangularclient" ng-controller="IndexController as indexCtrl">
    ...
    <asset:javascript src="/fr/isima/stackoverflow/applicationModules.js" />
</body>
</html>-->
...
<html lang="en" class="no-js">
    ...
    <body ng-app="fr.isima.stackoverflow" ng-controller="QuestionController as questionCtrl">
coucou

{{questions.recents}}
    <table>
        <tbody>
        <tr ng-repeat="q in vm.home()">
            <td>
                {{q.questions.recents}}
            </td>
            <!--<td>
    ...
    <!--<body ng-app="stackoverflowlikeangularclient" ng-controller="IndexController as indexCtrl">-->
        ...
        <!--<div ng-include="'/stackoverflowlikeangularclient/index/index.html'"></div>-->
        ...
        <asset:javascript src="/fr/isima/stackoverflow/applicationModules.js" />
        <--<asset:javascript src="/fr/isima/stackoverflow/controllers/questionController.js" />-->
    </body>
</html>