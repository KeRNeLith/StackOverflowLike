describe("stackoverflowlikeangularclient.index", function() {

    var $rootScope, $state, $location;

    beforeEach(angular.mock.module('stackoverflowlikeangularclient.index', function() {
    ...
    beforeEach(angular.mock.inject(function (_$rootScope_, $templateCache, _$state_, _$location_) {
        ...
        $templateCache.put('/stackoverflowlikeangularclient/index/index.html', '');
    }));
